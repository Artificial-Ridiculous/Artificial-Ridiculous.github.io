...
print("中序遍历-非递归:",preorder_recur)
print("后序遍历-非递归:",inorder_loop)
print("前序遍历-递归  :",inorder_recur)
print("中序遍历-递归  :",postorder_loop)
...
中序遍历-非递归: [5, 3, 2, 1, 4, 6]
后序遍历-非递归: [1, 2, 3, 4, 5, 6]
前序遍历-递归  : [1, 2, 3, 4, 5, 6]
中序遍历-递归  : [1, 2, 4, 3, 6, 5]
后序遍历-递归  : [1, 2, 4, 3, 6, 5]
```